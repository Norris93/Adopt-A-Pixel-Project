---
title: "Zooniverse Data Cleaning Tutorial Student Edition"
...
When you have completed the R Markdown, knit the file to a either a Word or HTML Document using the Knit down arrow button above!
...
```{r}
zooclean$latitude <- str_remove(zooclean$latitude, "e") #First one is done for you!
...
Try to join the IGBP Classifications table to the main data set by using the code above as an example!
```{r}
